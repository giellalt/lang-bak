...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_bak to login script."
...
# the current dir:
if   test x${GTLANG_bak} = x ; then
	echo "WARNING: The variable \${GTLANG_bak} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_bak} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_bak} has the value:"
	echo "  ${GTLANG_bak}"
