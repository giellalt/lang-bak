...
This directory contains source files for the Bashkir language morphology
...
-   <https://giellalt.uit.no/lang/doc/BashkirDocumentation.html>
    (analyser)
...
The Bashkir language sources can be acquired using [giella SVN
